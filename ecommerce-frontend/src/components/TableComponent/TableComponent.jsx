    ...
    const handleSort = (dataIndex, sorter) => {
        ...
        setSortConfig((prev) => {
            if (prev.key === dataIndex) {
                if (prev.direction === 'asc') return { key: dataIndex, direction: 'desc' }
                                ...
                                <div key={col.dataIndex}>
                                    ...
                                    <select
                                        ...
                                        onChange={(e) =>
                                            setFilters((f) => ({
                                                ...f,
                                                [col.dataIndex]: e.target.value || undefined,
                                            }))
                                        }>
            ...
            <div>
                ...
                <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
                    <Loading spinning={isLoading} tip="Đang tải...">
                        <table className="w-full text-sm text-left rtl:text-right text-gray-500 min-h-40">
                                ...
                                <tr>
                                    <th scope="col" className="p-4">
                                        <div className="flex items-center">
                                            <input
                                                ...
                                                checked={
                                                    sortedData.length > 0 &&
                                                    rowSelectedKeys.length === sortedData.length
                                                }
                                    ...
                                    {columns.map((column) => (
                                        <th
                                            ...
                                            onClick={() =>
                                                handleSort(column.dataIndex, column.sorter)
                                            }>
