...
const ProfilePage = () => {
    ...
    const handOnchangeAvatar = async (e) => {
        ...
        if (file) {
            const base64 = await getBase64(file, 500, 1024)
            setAvatar(base64)
        }
    }
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            ...
            const detailRes = await UserServices.getDetailsUser(user.id, user.access_token)
            dispatch(
                updateUser({
                    ...user,
                    ...detailRes?.data?.data,
    ...
    return (
        <div className="max-w-6xl text-base mx-auto text-[#000] h-[500px]">
            <div className="my-[4px] font-medium text-lg">Thông tin người dùng</div>
                ...
                {isLoading ? (
                    ...
                    <>
                        <div className="flex items-center ">
                            <label className="font-semibold w-1/6" htmlFor="name">
                                Name
                            </label>
                            <InputForm
                                className={'border-b bg-white w-5/6 mb-0 focus:bg-[#1a94ff]/[10%]'}
                                value={name}
                                id="name"
                        ...
                        <div className="flex items-center mt-4">
                            <label className="font-semibold w-1/6" htmlFor="email">
                                Email
                            </label>
                            <InputForm
                                className={'border-b bg-white w-5/6 mb-0 focus:bg-[#1a94ff]/[10%]'}
                        ...
                        <div className="flex items-center mt-4">
                            <label className="font-semibold w-1/6" htmlFor="phone">
                                Phone
                            </label>
                            <InputForm
                                className={'border-b bg-white w-5/6 mb-0 focus:bg-[#1a94ff]/[10%]'}
                        ...
                        <div className="flex items-center mt-4">
                            <label className="font-semibold w-1/6" htmlFor="address">
                                Address
                            </label>
                            <InputForm
                                className={'border-b bg-white w-5/6 mb-0 focus:bg-[#1a94ff]/[10%]'}
                        ...
                        <div className="flex items-center mt-4">
                            <label className="font-semibold w-1/6" htmlFor="avatar">
                                Avatar
                            </label>
                        ...
                        <ButtonComponent
                            ...
                            textButton={'Cập nhật'}
                            styleTextButton={'text-[15px] font-bold leading-none'}
